% beta (K_2,K_1)=(1,1),(1,10),(10,1),(10,10)
clc;
clear;
N  = [1:1:300];
stack  = [1 1;1 30;30 1;30 30];
c = 10;
transmit_antenna =round(N./c,0);
loop =10;
...
legend('$K_1=1,K_2=1$','$K_1=30,K_2=1$','$K_1=1,K_2=30$','$K_1=30,K_2=30$','Interpreter', 'latex');
xlabel('$N,n_t=2$','Interpreter', 'latex');
